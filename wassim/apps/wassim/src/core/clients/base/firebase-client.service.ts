...
export class FirebaseClient {
  ...
  public get<returnType>(
    ...
    return this.httpClient
      .get(environment.firebase.databaseURL + urlRoute + parameters, {
  ...
  public createUserWithCredentials(
    credentialsForCreationDto: CredentialsForCreationDto
  ): Promise<firebase.default.auth.UserCredential> {
    return this.auth.createUserWithEmailAndPassword(
      credentialsForCreationDto.email,
      credentialsForCreationDto.password
    );
  }
